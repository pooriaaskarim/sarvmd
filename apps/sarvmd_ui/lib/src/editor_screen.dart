                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  DocumentSettingsGroup(
                                    ...
                                    onPageSizeChanged: _notifier.updatePageSize,
                          ...
                          const Divider(height: 32),
                          // The Hierarchy Panel needs to be very stable,
                          // so we use a specialized builder for it.
                    ...
                    ListenableBuilder(
                      ...
                      builder: (context, _) => Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              '${_notifier.layout.systemCount} Systems',
                              style: TextStyle(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return RulerBox(
                    ...
                    paperSizeMm: Size(
                      _notifier.config.effectiveWidth,
                      _notifier.config.effectiveHeight,
                    ),
                    child: MouseRegion(
                      onHover: (event) {
                          ...
                          Positioned.fill(
                            child: InteractiveViewer(
                              ...
                              child: ListenableBuilder(
                                listenable: _notifier,
                                builder: (context, _) => PreviewCanvas(
                                  layout: _notifier.layout,
                                  viewNotifier: widget.viewNotifier,
                                ),
                              ),
                            ),
