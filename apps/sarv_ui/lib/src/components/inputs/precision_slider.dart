...
class ZoomSliderControls extends StatefulWidget {
  ...
  @override
  State<ZoomSliderControls> createState() => _ZoomSliderControlsState();
}

class _ZoomSliderControlsState extends State<ZoomSliderControls> {
  late final TextEditingController _controller;
  ...
  @override
  void didUpdateWidget(ZoomSliderControls oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.value != widget.value) {
