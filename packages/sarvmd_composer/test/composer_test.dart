...
void main() {
  group('MusicXmlTranscriber', () {
    test('scoreToMusicXml generates valid MusicXML header and tags', () {
      ...
      expect(xml, contains('<creator type="composer">Ludwig van Beethoven</creator>'));
      expect(xml, contains('<part-name>Violin I</part-name>'));
    });

    test('musicXmlToScore extracts title and composer from XML source', () {
      const xml = '''
...
''';
      ...
      expect(score.composer, equals('Frédéric Chopin'));
    });
  });
}
