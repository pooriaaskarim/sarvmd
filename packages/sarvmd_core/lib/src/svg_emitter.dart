...
String emitSvg(PageConfig config, PageLayout layout) {
  ...
  for (final system in layout.systems) {
    ...
    if (connector != SystemConnector.none && system.staves.length > 1) {
      ...
      final sysBottomY =
          system.staves.last.topY + system.staves.last.height;
...
const String _percClefSvg = "M300 200V800H400V200H300Z M500 200V800H600V200H500Z";

const String _tabClefSvg = "M200 850H800V750H550V650H450V750H200V850Z M350 600L500 400L650 600H550L500 500L450 600H350Z M250 350V50H550V150H300V200H550V350H250Z";
